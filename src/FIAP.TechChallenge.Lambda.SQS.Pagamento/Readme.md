...
Execute unit tests
```
    cd "FIAP.TechChallenge.Lambda.SQS.Pagamento/test/FIAP.TechChallenge.Lambda.SQS.Pagamento.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "FIAP.TechChallenge.Lambda.SQS.Pagamento/src/FIAP.TechChallenge.Lambda.SQS.Pagamento"
